...
using System;
namespace Common.Tba.Api.Teams.Item.Simple
{
    /// <summary>
    /// Builds and executes requests for operations under \teams\{page_num-id}\simple
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SimpleRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Common.Tba.Api.Teams.Item.Simple.SimpleRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SimpleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{page_num%2Did}/simple", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Common.Tba.Api.Teams.Item.Simple.SimpleRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SimpleRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams/{page_num%2Did}/simple", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Common.Tba.Api.Teams.Item.Simple.SimpleRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Common.Tba.Api.Teams.Item.Simple.SimpleRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Common.Tba.Api.Teams.Item.Simple.SimpleRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
