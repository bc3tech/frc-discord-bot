...
[assembly: SuppressMessage("Performance", "EA0004:Make types declared in an executable internal", Justification = "Must be public to work with Discord.Net", Scope = "type", Target = "~T:DiscordBotFunctionApp.DiscordInterop.CommandModules.ScheduleCommandModule")]
[assembly: SuppressMessage("Resilience", "EA0014:The async method doesn't support cancellation", Justification = "Can't use CTs in command signatures as not compatible with injection model", Scope = "type", Target = "~T:DiscordBotFunctionApp.DiscordInterop.CommandModules.ScheduleCommandModule")]
