...
namespace FIRST.Test.Api
    ...
    /// </remarks>
    public class AwardsApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsType' AwardsApi
            //Assert.IsType<AwardsApi>(instance);
        }

        /// <summary>
        /// Test SeasonAwardsEventEventCodeGet
        /// </summary>
        [Fact]
        public void SeasonAwardsEventEventCodeGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string eventCode = null;
            //string season = null;
            //string? ifModifiedSince = null;
            //var response = instance.SeasonAwardsEventEventCodeGet(eventCode, season, ifModifiedSince);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonAwardsEventteamEventCodeTeamNumberGet
        /// </summary>
        [Fact]
        public void SeasonAwardsEventteamEventCodeTeamNumberGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string eventCode = null;
            //string season = null;
            //string teamNumber = null;
            //var response = instance.SeasonAwardsEventteamEventCodeTeamNumberGet(eventCode, season, teamNumber);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonAwardsListGet
        /// </summary>
        [Fact]
        public void SeasonAwardsListGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //string? ifModifiedSince = null;
            //var response = instance.SeasonAwardsListGet(season, ifModifiedSince);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonAwardsTeamTeamNumberGet
        /// </summary>
        [Fact]
        public void SeasonAwardsTeamTeamNumberGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //string teamNumber = null;
            //var response = instance.SeasonAwardsTeamTeamNumberGet(season, teamNumber);
            //Assert.IsType<Object>(response);
        }
    }
