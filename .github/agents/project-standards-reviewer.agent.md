...
## Evidence requirementsEvery finding must include:
...
2. The **specific line(s) in the diff** that violate the rule.A finding without both a cited rule and a cited violation is not a finding. Drop it.
