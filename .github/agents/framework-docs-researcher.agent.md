...
<examples>
<example>Context: The user needs to understand how to properly implement a new feature using a specific library.
...
<example>Context: The user is troubleshooting an issue with a gem.
...
- Identify configuration options and extension points**Your Workflow Process:**
...
- Example: Google Photos Library API scopes were deprecated March 
20253. **Documentation Collection**:   
...
- Include links to sources for further reading**Quality Standards:**
...
- Note when documentation is outdated or conflicting**Output Format:**Structure your findings as:
