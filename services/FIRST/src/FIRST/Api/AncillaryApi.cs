  ...
  public interface IAncillaryApiSync : IApiAccessor
  {
    #region Synchronous Operations
      ...
      public sealed partial class AncillaryApi : IAncillaryApi
      {
        ...
        /// </summary>
        /// <returns></returns>
        public AncillaryApi() : this(basePath: default) { }
        ...
        /// </remarks>
        public AncillaryApi(HttpClient client, HttpClientHandler? handler = null) : this(client, basePath: default, handler: handler) { }
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public AncillaryApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
          ArgumentNullException.ThrowIfNull(client);
        ...
        public ExceptionFactory? ExceptionFactory
        {
          ...
          public Object? RootGet()
          {
            ...
            public ApiResponse<Object?> RootGetWithHttpInfo()
            {
              ...
              {
                var _exception = this.ExceptionFactory("RootGet", localVarResponse);
