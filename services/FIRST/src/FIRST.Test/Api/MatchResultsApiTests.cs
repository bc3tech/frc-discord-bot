...
namespace FIRST.Test.Api
    ...
    /// <summary>
    ///  Class for testing MatchResultsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class MatchResultsApiTests : IDisposable
    {
        private MatchResultsApi instance;

        public MatchResultsApiTests()
        {
            instance = new MatchResultsApi();
        }
        ...
        /// <summary>
        /// Test an instance of MatchResultsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' MatchResultsApi
            //Assert.IsType<MatchResultsApi>(instance);
        }

        /// <summary>
        /// Test SeasonMatchesEventCodeGet
        /// </summary>
        [Fact]
        public void SeasonMatchesEventCodeGetTest()
        {
            ...
            //var response = instance.SeasonMatchesEventCodeGet(eventCode, season, end, ifModifiedSince, matchNumber, start, teamNumber, tournamentLevel);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonScoresEventCodeTournamentLevelGet
        /// </summary>
        [Fact]
        public void SeasonScoresEventCodeTournamentLevelGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string eventCode = null;
            //string season = null;
            ...
            //string? matchNumber = null;
            //string? start = null;
            //var response = instance.SeasonScoresEventCodeTournamentLevelGet(eventCode, season, tournamentLevel, end, ifModifiedSince, matchNumber, start);
            //Assert.IsType<Object>(response);
        }
    }
