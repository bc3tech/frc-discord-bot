...
namespace FIRST.Test.Api
    ...
    /// <summary>
    ///  Class for testing SeasonDataApi
    /// </summary>
    /// <remarks>
    ...
    public class SeasonDataApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test an instance of SeasonDataApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' SeasonDataApi
            //Assert.IsType<SeasonDataApi>(instance);
        }

        /// <summary>
        /// Test SeasonAvatarsGet
        /// </summary>
        [Fact]
        public void SeasonAvatarsGetTest()
        {
            ...
            //var response = instance.SeasonAvatarsGet(season, eventCode, ifModifiedSince, page, teamNumber);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonDistrictsGet
        /// </summary>
        [Fact]
        public void SeasonDistrictsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //string? ifModifiedSince = null;
            //var response = instance.SeasonDistrictsGet(season, ifModifiedSince);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonEventsGet
        /// </summary>
        [Fact]
        public void SeasonEventsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //string? districtCode = null;
            //string? eventCode = null;
            //string? excludeDistrict = null;
            //string? ifModifiedSince = null;
            //string? teamNumber = null;
            //string? tournamentType = null;
            //string? weekNumber = null;
            //var response = instance.SeasonEventsGet(season, districtCode, eventCode, excludeDistrict, ifModifiedSince, teamNumber, tournamentType, weekNumber);
            //Assert.IsType<Object>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void SeasonGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //string? ifModifiedSince = null;
            //var response = instance.SeasonGet(season, ifModifiedSince);
            //Assert.IsType<Object>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void SeasonTeamsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //string? districtCode = null;
            ...
            //string? state = null;
            //string? teamNumber = null;
            //var response = instance.SeasonTeamsGet(season, districtCode, eventCode, ifModifiedSince, page, state, teamNumber);
            //Assert.IsType<Object>(response);
        }
    }
