...
namespace FIRST.Test.Api
    ...
    public class ScheduleApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test SeasonScheduleEventCodeGet
        /// </summary>
        [Fact]
        public void SeasonScheduleEventCodeGetTest()
        {
            ...
            //var response = instance.SeasonScheduleEventCodeGet(eventCode, season, end, ifModifiedSince, start, teamNumber, tournamentLevel);
