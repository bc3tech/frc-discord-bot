...
namespace FIRST.Test.Api
    ...
    /// </remarks>
    public class RankingsDistrictRankingCalculationApiTests : IDisposable
    {
        private RankingsDistrictRankingCalculationApi instance;

        public RankingsDistrictRankingCalculationApiTests()
        {
            instance = new RankingsDistrictRankingCalculationApi();
        }
        ...
        /// <summary>
        /// Test an instance of RankingsDistrictRankingCalculationApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' RankingsDistrictRankingCalculationApi
            //Assert.IsType<RankingsDistrictRankingCalculationApi>(instance);
        }

        /// <summary>
        /// Test SeasonRankingsDistrictAllianceSelectionCalculationGet
        /// </summary>
        [Fact]
        public void SeasonRankingsDistrictAllianceSelectionCalculationGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //var response = instance.SeasonRankingsDistrictAllianceSelectionCalculationGet(season);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonRankingsDistrictPlayoffAdvancementCalculationGet
        /// </summary>
        [Fact]
        public void SeasonRankingsDistrictPlayoffAdvancementCalculationGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //var response = instance.SeasonRankingsDistrictPlayoffAdvancementCalculationGet(season);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test SeasonRankingsDistrictQualPerformanceCalculationGet
        /// </summary>
        [Fact]
        public void SeasonRankingsDistrictQualPerformanceCalculationGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string season = null;
            //var response = instance.SeasonRankingsDistrictQualPerformanceCalculationGet(season);
            //Assert.IsType<Object>(response);
        }
    }
