...
internal sealed record AnswerEvaluationResult(
...
internal static class AnswerEvaluationResultParser
{
    ...
    public static ChatResponseFormat ResponseFormat { get; } = ChatResponseFormat.ForJsonSchema(
        s_jsonSchema,
        schemaName: "answer_evaluation_result",
        schemaDescription: "Evaluator result with an accept or repair decision and optional repair feedback.");

    public static bool TryParse(
        string payload,
        out AnswerEvaluationResult? result,
