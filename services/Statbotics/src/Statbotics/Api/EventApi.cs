...
public interface IEventApiSync : IApiAccessor
{
    ...
    EventStats? ReadEventV3EventEventGet(string varEvent);
    ...
    ApiResponse<EventStats?> ReadEventV3EventEventGetWithHttpInfo(string varEvent);
    /// <summary>
    ...
    Collection<EventStats>? ReadEventsV3EventsGet(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? type = default, int? week = default, int? year = default);
    ...
    ApiResponse<Collection<EventStats>?> ReadEventsV3EventsGetWithHttpInfo(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? type = default, int? week = default, int? year = default);
...
public interface IEventApiAsync : IApiAccessor
{
    ...
    Task<EventStats?> ReadEventV3EventEventGetAsync(string varEvent, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<EventStats?>> ReadEventV3EventEventGetWithHttpInfoAsync(string varEvent, CancellationToken cancellationToken = default);
    /// <summary>
    /// Query multiple events
    /// </summary>
    /// <remarks>
    ...
    Task<ApiResponse<Collection<EventStats>?>> ReadEventsV3EventsGetWithHttpInfoAsync(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? type = default, int? week = default, int? year = default, CancellationToken cancellationToken = default);
...
public sealed partial class EventApi : IEventApi
{
    ...
    /// <param name="varEvent"></param>
    /// <returns>Object</returns>
    public EventStats? ReadEventV3EventEventGet(string varEvent)
    {
        Statbotics.Client.ApiResponse<EventStats?> localVarResponse = ReadEventV3EventEventGetWithHttpInfo(varEvent);
    ...
    /// <param name="varEvent"></param>
    /// <returns>ApiResponse of Object</returns>
    public ApiResponse<EventStats?> ReadEventV3EventEventGetWithHttpInfo(string varEvent)
    {
        ...
        var localVarResponse = this.Client.Get<EventStats?>("/v3/event/{event}", localVarRequestOptions, this.Configuration);
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of Object</returns>
    public async Task<EventStats?> ReadEventV3EventEventGetAsync(string varEvent, CancellationToken cancellationToken = default)
    {
        Statbotics.Client.ApiResponse<EventStats?> localVarResponse = await ReadEventV3EventEventGetWithHttpInfoAsync(varEvent, cancellationToken).ConfigureAwait(false);
        return localVarResponse.Data;
    }
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ApiResponse (Object)</returns>
    public async Task<Statbotics.Client.ApiResponse<EventStats?>> ReadEventV3EventEventGetWithHttpInfoAsync(string varEvent, CancellationToken cancellationToken = default)
    {
        // verify the required parameter 'varEvent' is set
        if (varEvent is null)
        {
        ...
        localVarRequestOptions.PathParameters.Add("event", ClientUtils.ParameterToString(varEvent)); // path parameter
                                                                                                     // make the HTTP request
        var localVarResponse = await this.AsynchronousClient.GetAsync<EventStats?>("/v3/event/{event}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        return localVarResponse;
               ...
               /// <param name="year">Four-digit year (optional)</param>
               /// <returns>Collection&lt;Object&gt;</returns>
    public Collection<EventStats>? ReadEventsV3EventsGet(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? type = default, int? week = default, int? year = default)
    {
        Statbotics.Client.ApiResponse<Collection<EventStats>?> localVarResponse = ReadEventsV3EventsGetWithHttpInfo(ascending, country, district, limit, metric, offseason, offset, state, type, week, year);
        return localVarResponse.Data;
    }
    ...
    /// <param name="year">Four-digit year (optional)</param>
    /// <returns>ApiResponse of Collection&lt;Object&gt;</returns>
    public ApiResponse<Collection<EventStats>?> ReadEventsV3EventsGetWithHttpInfo(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? type = default, int? week = default, int? year = default)
    {
        RequestOptions localVarRequestOptions = new();
        ...
        // make the HTTP request
        var localVarResponse = this.Client.Get<Collection<EventStats>?>("/v3/events", localVarRequestOptions, this.Configuration);
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of Collection&lt;Object&gt;</returns>
    public async Task<Collection<EventStats>?> ReadEventsV3EventsGetAsync(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? type = default, int? week = default, int? year = default, CancellationToken cancellationToken = default)
    {
        Statbotics.Client.ApiResponse<Collection<EventStats>?> localVarResponse = await ReadEventsV3EventsGetWithHttpInfoAsync(ascending, country, district, limit, metric, offseason, offset, state, type, week, year, cancellationToken).ConfigureAwait(false);
        return localVarResponse.Data;
    }
    ...
    /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    /// <returns>Task of ApiResponse (Collection&lt;Object&gt;)</returns>
    public async Task<Statbotics.Client.ApiResponse<Collection<EventStats>?>> ReadEventsV3EventsGetWithHttpInfoAsync(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? type = default, int? week = default, int? year = default, CancellationToken cancellationToken = default)
    {
        RequestOptions localVarRequestOptions = new();
        ...
        // make the HTTP request
        var localVarResponse = await this.AsynchronousClient.GetAsync<Collection<EventStats>?>("/v3/events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
