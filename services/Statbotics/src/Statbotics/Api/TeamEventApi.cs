...
using Statbotics.Model;
  ...
  /// </summary>
  internal interface ITeamEventApiSync : IApiAccessor
  {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface ITeamEventApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface ITeamEventApi : ITeamEventApiSync, ITeamEventApiAsync { }
    
    /// <summary>
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal partial class TeamEventApi : ITeamEventApi
    {
      ...
      /// </summary>
      /// <returns></returns>
      public TeamEventApi() : this((string)null) { }
      ...
      /// </remarks>
      public TeamEventApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler) { }
      ...
      /// <exception cref="ArgumentNullException"></exception>
      public TeamEventApi(Statbotics.Client.ISynchronousClient client, Statbotics.Client.IAsynchronousClient asyncClient, Statbotics.Client.IReadableConfiguration configuration)
      {
        ArgumentNullException.ThrowIfNull(client);
      ...
      public ExceptionFactory ExceptionFactory
      {
        ...
        {
          Statbotics.Client.ApiResponse<Object> localVarResponse = ReadTeamEventV3TeamEventTeamEventGetWithHttpInfo(team, varEvent);
          ...
          public ApiResponse<Object> ReadTeamEventV3TeamEventTeamEventGetWithHttpInfo(string team, string varEvent)
          {
            ...
            {
              Exception _exception = this.ExceptionFactory("ReadTeamEventV3TeamEventTeamEventGet", localVarResponse);
        ...
        {
          Statbotics.Client.ApiResponse<Collection<Object>> localVarResponse = ReadTeamEventsV3TeamEventsGetWithHttpInfo(ascending, country, district, limit, metric, offseason, offset, state, team, type, varEvent, week, year);
            return localVarResponse.Data;
          }
          ...
          public ApiResponse<Collection<Object>> ReadTeamEventsV3TeamEventsGetWithHttpInfo(bool? ascending = default, string? country = default, string? district = default, int? limit = default, string? metric = default, bool? offseason = default, int? offset = default, string? state = default, string? team = default, string? type = default, string? varEvent = default, int? week = default, int? year = default)
          {
            ...
            if (this.ExceptionFactory is not null)
            {
              Exception _exception = this.ExceptionFactory("ReadTeamEventsV3TeamEventsGet", localVarResponse);
              if (_exception is not null)
              {
                throw _exception;
              }
