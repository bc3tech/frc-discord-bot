  ...
  internal interface ITeamMatchApiSync : IApiAccessor
  {
    ...
    internal interface ITeamMatchApiAsync : IApiAccessor
    {
      #region Asynchronous Operations
        ...
        System.Threading.Tasks.Task<Object> ReadTeamMatchV3TeamMatchTeamMatchGetAsync(string match, string team, CancellationToken cancellationToken = default);
          ...
          System.Threading.Tasks.Task<ApiResponse<Object>> ReadTeamMatchV3TeamMatchTeamMatchGetWithHttpInfoAsync(string match, string team, CancellationToken cancellationToken = default);
        /// <summary>
        /// Query multiple team matches
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Collection<Object>> ReadTeamMatchesV3TeamMatchesGetAsync(bool? ascending = default, bool? elim = default, int? limit = default, string? match = default, string? metric = default, bool? offseason = default, int? offset = default, string? team = default, string? varEvent = default, int? week = default, int? year = default, CancellationToken cancellationToken = default);
          ...
          System.Threading.Tasks.Task<ApiResponse<Collection<Object>>> ReadTeamMatchesV3TeamMatchesGetWithHttpInfoAsync(bool? ascending = default, bool? elim = default, int? limit = default, string? match = default, string? metric = default, bool? offseason = default, int? offset = default, string? team = default, string? varEvent = default, int? week = default, int? year = default, CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal partial class TeamMatchApi : ITeamMatchApi
    {
      ...
      /// </summary>
      /// <returns></returns>
      public TeamMatchApi() : this((string)null) { }
      ...
      /// <returns></returns>
      public TeamMatchApi(Statbotics.Client.Configuration configuration)
      {
      ...
      /// </remarks>
      public TeamMatchApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler) { }
      ...
      /// <exception cref="ArgumentNullException"></exception>
      public TeamMatchApi(Statbotics.Client.ISynchronousClient client, Statbotics.Client.IAsynchronousClient asyncClient, Statbotics.Client.IReadableConfiguration configuration)
      {
        ArgumentNullException.ThrowIfNull(client);
      ...
      public ExceptionFactory ExceptionFactory
      {
        ...
        public Object ReadTeamMatchV3TeamMatchTeamMatchGet(string match, string team)
        {
          ...
          public ApiResponse<Object> ReadTeamMatchV3TeamMatchTeamMatchGetWithHttpInfo(string match, string team)
          {
            ...
            {
              Exception _exception = this.ExceptionFactory("ReadTeamMatchV3TeamMatchTeamMatchGet", localVarResponse);
          ...
          /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
          /// <returns>Task of Object</returns>
          public async System.Threading.Tasks.Task<Object> ReadTeamMatchV3TeamMatchTeamMatchGetAsync(string match, string team, CancellationToken cancellationToken = default)
            {
              ...
              /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
              /// <returns>Task of ApiResponse (Object)</returns>
              public async System.Threading.Tasks.Task<Statbotics.Client.ApiResponse<Object>> ReadTeamMatchV3TeamMatchTeamMatchGetWithHttpInfoAsync(string match, string team, CancellationToken cancellationToken = default)
              {
                      // verify the required parameter 'match' is set
                      if (match is null)
                      {
        ...
        public Collection<Object> ReadTeamMatchesV3TeamMatchesGet(bool? ascending = default, bool? elim = default, int? limit = default, string? match = default, string? metric = default, bool? offseason = default, int? offset = default, string? team = default, string? varEvent = default, int? week = default, int? year = default)
        {
          ...
          public ApiResponse<Collection<Object>> ReadTeamMatchesV3TeamMatchesGetWithHttpInfo(bool? ascending = default, bool? elim = default, int? limit = default, string? match = default, string? metric = default, bool? offseason = default, int? offset = default, string? team = default, string? varEvent = default, int? week = default, int? year = default)
          {
            ...
            if (this.ExceptionFactory is not null)
            {
              Exception _exception = this.ExceptionFactory("ReadTeamMatchesV3TeamMatchesGet", localVarResponse);
              if (_exception is not null)
              {
                throw _exception;
              }
          ...
          /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
          /// <returns>Task of Collection&lt;Object&gt;</returns>
          public async System.Threading.Tasks.Task<Collection<Object>> ReadTeamMatchesV3TeamMatchesGetAsync(bool? ascending = default, bool? elim = default, int? limit = default, string? match = default, string? metric = default, bool? offseason = default, int? offset = default, string? team = default, string? varEvent = default, int? week = default, int? year = default, CancellationToken cancellationToken = default)
            {
