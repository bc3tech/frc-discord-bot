...
<a id="getstatus"></a>
# **GetStatus**
> APIStatus GetStatus (string? ifNoneMatch = null)
...
namespace Example
{
    public class GetStatusExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new TBAApi(httpClient, config, httpClientHandler);
...
try
{
    ApiResponse<APIStatus> response = apiInstance.GetStatusWithHttpInfo(ifNoneMatch);
...
{
    Debug.Print("Exception when calling TBAApi.GetStatusWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
