# TheBlueAlliance.Api.Model.DistrictRanking
...
**EventPoints** | [**List&lt;DistrictRankingEventPointsInner&gt;**](DistrictRankingEventPointsInner.md) | List of events that contributed to the point total for the team. | [optional] 
