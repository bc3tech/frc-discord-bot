...
public class Configuration : IReadableConfiguration
{
    ...
    public Configuration()
    {
        ...
        _basePath = "https://www.thebluealliance.com/api/v3";
        DefaultHeaders = new ConcurrentDictionary<string, string>();
        _apiKey = new ConcurrentDictionary<string, string>();
        _apiKeyPrefix = new ConcurrentDictionary<string, string>();
        _servers = new List<IReadOnlyDictionary<string, object>>()
        {
            {
        ...
        _operationServers = new Dictionary<string, List<IReadOnlyDictionary<string, object>>>() { };
    ...
    {
        if (ApiKey.TryGetValue(apiKeyIdentifier, out var apiKeyValue))
        {
    ...
    /// <param name="inputVariables">Dictionary of the variables and the corresponding values.</param>
    /// <return>The server URL.</return>
    static private string GetServerUrl(IList<IReadOnlyDictionary<string, object>> servers, int index, Dictionary<string, string>? inputVariables)
    {
    ...
    {
        string report = "C# SDK (TheBlueAlliance.Api) Debug Report:\n";
    ...
    public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second)
    {
        ...
        var config = new Configuration
        {
            ...
            UserAgent = second.UserAgent.UnlessNullOrWhitespaceThen(first.UserAgent),
            Username = second.Username ?? first.Username,
            Password = second.Password ?? first.Password,
            AccessToken = second.AccessToken ?? first.AccessToken,
            TempFolderPath = second.TempFolderPath.UnlessNullOrWhitespaceThen(first.TempFolderPath),
            DateTimeFormat = second.DateTimeFormat.UnlessNullOrWhitespaceThen(first.DateTimeFormat),
