...
/// </summary>
public partial class LeaderboardInsightDataRankingsInner : IValidatableObject
{
    /// <summary>
    ...
    public LeaderboardInsightDataRankingsInner(decimal value = default, List<string>? keys = default)
    {
        this.Value = value;
    ...
    public override string ToString()
    {
        ...
        sb.Append("  Value: ").AppendLine(Value.ToString());
        sb.Append("  Keys: ").AppendLine(Keys.ToString());
        sb.AppendLine("}");
        return sb.ToString();
    }
