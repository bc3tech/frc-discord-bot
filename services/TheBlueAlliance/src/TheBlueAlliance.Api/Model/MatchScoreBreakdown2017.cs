...
/// </summary>
public partial class MatchScoreBreakdown2017 : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MatchScoreBreakdown2017" /> class.
    /// </summary>
    [JsonConstructor]
    protected MatchScoreBreakdown2017() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="MatchScoreBreakdown2017" /> class.
    /// </summary>
    /// <param name="blue">blue (required).</param>
    /// <param name="red">red (required).</param>
    public MatchScoreBreakdown2017(MatchScoreBreakdown2017Alliance? blue = default, MatchScoreBreakdown2017Alliance? red = default)
    {
