...
public partial class MatchScoreBreakdown2019Alliance(int adjustPoints = default, int autoPoints = default, string? bay1 = default, string? bay2 = default, string? bay3 = default, string? bay4 = default, string? bay5 = default, string? bay6 = default, string? bay7 = default, string? bay8 = default, int cargoPoints = default, bool completeRocketRankingPoint = default, bool completedRocketFar = default, bool completedRocketNear = default, string? endgameRobot1 = default, string? endgameRobot2 = default, string? endgameRobot3 = default, int foulCount = default, int foulPoints = default, int habClimbPoints = default, bool habDockingRankingPoint = default, string? habLineRobot1 = default, string? habLineRobot2 = default, string? habLineRobot3 = default, int hatchPanelPoints = default, string? lowLeftRocketFar = default, string? lowLeftRocketNear = default, string? lowRightRocketFar = default, string? lowRightRocketNear = default, string? midLeftRocketFar = default, string? midLeftRocketNear = default, string? midRightRocketFar = default, string? midRightRocketNear = default, string? preMatchBay1 = default, string? preMatchBay2 = default, string? preMatchBay3 = default, string? preMatchBay6 = default, string? preMatchBay7 = default, string? preMatchBay8 = default, string? preMatchLevelRobot1 = default, string? preMatchLevelRobot2 = default, string? preMatchLevelRobot3 = default, int rp = default, int sandStormBonusPoints = default, int techFoulCount = default, int teleopPoints = default, string? topLeftRocketFar = default, string? topLeftRocketNear = default, string? topRightRocketFar = default, string? topRightRocketNear = default, int totalPoints = default) : IValidatableObject
{
    ...
    public override string ToString()
    {
        ...
        sb.Append("  Bay1: ").AppendLine(Bay1.ToString());
        sb.Append("  Bay2: ").AppendLine(Bay2.ToString());
        sb.Append("  Bay3: ").AppendLine(Bay3.ToString());
        sb.Append("  Bay4: ").AppendLine(Bay4.ToString());
        sb.Append("  Bay5: ").AppendLine(Bay5.ToString());
        sb.Append("  Bay6: ").AppendLine(Bay6.ToString());
        sb.Append("  Bay7: ").AppendLine(Bay7.ToString());
        sb.Append("  Bay8: ").AppendLine(Bay8.ToString());
        sb.Append("  CargoPoints: ").AppendLine(CargoPoints.ToString());
        sb.Append("  CompleteRocketRankingPoint: ").AppendLine(CompleteRocketRankingPoint.ToString());
        sb.Append("  CompletedRocketFar: ").AppendLine(CompletedRocketFar.ToString());
        sb.Append("  CompletedRocketNear: ").AppendLine(CompletedRocketNear.ToString());
        ...
        sb.Append("  HabClimbPoints: ").AppendLine(HabClimbPoints.ToString());
        sb.Append("  HabDockingRankingPoint: ").AppendLine(HabDockingRankingPoint.ToString());
        sb.Append("  HabLineRobot1: ").AppendLine(HabLineRobot1.ToString());
        sb.Append("  HabLineRobot2: ").AppendLine(HabLineRobot2.ToString());
        sb.Append("  HabLineRobot3: ").AppendLine(HabLineRobot3.ToString());
        sb.Append("  HatchPanelPoints: ").AppendLine(HatchPanelPoints.ToString());
        sb.Append("  LowLeftRocketFar: ").AppendLine(LowLeftRocketFar.ToString());
        sb.Append("  LowLeftRocketNear: ").AppendLine(LowLeftRocketNear.ToString());
        sb.Append("  LowRightRocketFar: ").AppendLine(LowRightRocketFar.ToString());
        sb.Append("  LowRightRocketNear: ").AppendLine(LowRightRocketNear.ToString());
        sb.Append("  MidLeftRocketFar: ").AppendLine(MidLeftRocketFar.ToString());
        sb.Append("  MidLeftRocketNear: ").AppendLine(MidLeftRocketNear.ToString());
        sb.Append("  MidRightRocketFar: ").AppendLine(MidRightRocketFar.ToString());
        sb.Append("  MidRightRocketNear: ").AppendLine(MidRightRocketNear.ToString());
        sb.Append("  PreMatchBay1: ").AppendLine(PreMatchBay1.ToString());
        sb.Append("  PreMatchBay2: ").AppendLine(PreMatchBay2.ToString());
        sb.Append("  PreMatchBay3: ").AppendLine(PreMatchBay3.ToString());
        sb.Append("  PreMatchBay6: ").AppendLine(PreMatchBay6.ToString());
        sb.Append("  PreMatchBay7: ").AppendLine(PreMatchBay7.ToString());
        sb.Append("  PreMatchBay8: ").AppendLine(PreMatchBay8.ToString());
        sb.Append("  PreMatchLevelRobot1: ").AppendLine(PreMatchLevelRobot1.ToString());
        sb.Append("  PreMatchLevelRobot2: ").AppendLine(PreMatchLevelRobot2.ToString());
        sb.Append("  PreMatchLevelRobot3: ").AppendLine(PreMatchLevelRobot3.ToString());
        sb.Append("  Rp: ").AppendLine(Rp.ToString());
        sb.Append("  SandStormBonusPoints: ").AppendLine(SandStormBonusPoints.ToString());
        sb.Append("  TechFoulCount: ").AppendLine(TechFoulCount.ToString());
        sb.Append("  TeleopPoints: ").AppendLine(TeleopPoints.ToString());
        sb.Append("  TopLeftRocketFar: ").AppendLine(TopLeftRocketFar.ToString());
        sb.Append("  TopLeftRocketNear: ").AppendLine(TopLeftRocketNear.ToString());
        sb.Append("  TopRightRocketFar: ").AppendLine(TopRightRocketFar.ToString());
        sb.Append("  TopRightRocketNear: ").AppendLine(TopRightRocketNear.ToString());
