...
/// </summary>
public partial class MatchScoreBreakdown2016 : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MatchScoreBreakdown2016" /> class.
    /// </summary>
    [JsonConstructor]
    protected MatchScoreBreakdown2016() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="MatchScoreBreakdown2016" /> class.
    /// </summary>
    /// <param name="blue">blue (required).</param>
    /// <param name="red">red (required).</param>
    public MatchScoreBreakdown2016(MatchScoreBreakdown2016Alliance? blue = default, MatchScoreBreakdown2016Alliance? red = default)
    {
    ...
    public override string ToString()
    {
        ...
        sb.AppendLine("class MatchScoreBreakdown2016 {");
