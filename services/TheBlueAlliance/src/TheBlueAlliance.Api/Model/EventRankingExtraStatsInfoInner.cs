...
/// </summary>
public partial class EventRankingExtraStatsInfoInner : IValidatableObject
{
    /// <summary>
    ...
    public EventRankingExtraStatsInfoInner(decimal precision = default, string? name = default)
    {
    ...
    public override string ToString()
    {
        ...
        sb.AppendLine("class EventRankingExtraStatsInfoInner {");
