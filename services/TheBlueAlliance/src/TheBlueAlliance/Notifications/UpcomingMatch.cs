...
public record UpcomingMatch(string event_key, string match_key, string? team_key, string event_name, string[] team_keys, int? scheduled_time, int? predicted_time, Webcast? webcast);