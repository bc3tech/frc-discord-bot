...
public record MatchVideo(string event_key, string match_key, string? team_key, string event_name, Match? match) : MatchScore(event_key, match_key, team_key, event_name, match);
