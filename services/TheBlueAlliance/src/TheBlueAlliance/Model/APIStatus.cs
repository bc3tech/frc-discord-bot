...
public partial record APIStatus
{
    ...
    /// <param name="maxTeamPage">Maximum team page number for valid queries. (required).</param>
    public APIStatus(APIStatusAppVersion android, int currentSeason, Collection<string> downEvents, APIStatusAppVersion ios, bool isDatafeedDown, int maxSeason, int maxTeamPage)
    {
    ...
    /// </summary>
    /// <value>Maximum team page number for valid queries.</value>
    [JsonRequired]
    [JsonPropertyName("max_team_page")]
    public int MaxTeamPage { get; set; }
