...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
  public partial class EventRankingRankingsInner
  {
        ...
        public EventRankingRankingsInner(int dq, Collection<decimal> extraStats, int matchesPlayed, int? qualAverage, int rank, WLTRecord record, Collection<float> sortOrders, string teamKey)
        {
                      this.Dq = dq;
