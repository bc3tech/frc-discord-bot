...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
  public partial record Event
  {
        ...
        /// </summary>
            ...
            /// <param name="eventType">Event Type, as defined here: https://github.com/the-blue-alliance/the-blue-alliance/blob/main/src/backend/common/consts/event_type.py#L8 (required).</param>
            ...
            /// <param name="gmapsPlaceId">Google Maps Place ID for the event address. Will be NULL, for future development. (required).</param>
            /// <param name="gmapsUrl">Link to address location on Google Maps. Will be NULL, for future development. (required).</param>
            ...
            /// <param name="lat">Latitude for the event address. Will be NULL, for future development. (required).</param>
            /// <param name="lng">Longitude for the event address. Will be NULL, for future development. (required).</param>
            ...
            /// <param name="playoffType">Playoff Type, as defined under &#x60;PlayoffType&#x60;: https://github.com/the-blue-alliance/the-blue-alliance/blob/main/src/backend/common/consts/playoff_type.py#L37, or null. (required).</param>
            ...
            /// <param name="remapTeams">Map of temporary \&quot;off-season demo\&quot; team numbers to pre-rookie and B teams. Both keys and values are team keys in the format &#39;frc####&#39;. Key is the old team key (&#39;frc&#39; + numeric only), value is the new team key (&#39;frc&#39; + numeric + may include a letter suffix). (required).</param>
            ...
            /// <param name="timezone">IANA Timezone identifier. (required).</param>
        ...
        public Event(string address, string city, string country, District district, Collection<string> divisionKeys, DateOnly endDate, string eventCode, int eventType, string eventTypeString, string firstEventCode, string firstEventId, string gmapsPlaceId, string gmapsUrl, string key, double? lat, double? lng, string locationName, string name, string parentEventKey, int? playoffType, string playoffTypeString, string postalCode, Dictionary<string, string> remapTeams, string shortName, DateOnly startDate, string stateProv, string timezone, Collection<Webcast> webcasts, string website, int? week, int year)
        {
                      ...
                      // to ensure "remapTeams" is required (not null)
                      ArgumentNullException.ThrowIfNull(remapTeams);
                      this.RemapTeams = remapTeams;
              ...
              /// </summary>
              /// <value>Event Type, as defined here: https://github.com/the-blue-alliance/the-blue-alliance/blob/main/src/backend/common/consts/event_type.py#L8</value>
                [JsonRequired]
              ...
              /// </summary>
              /// <value>Google Maps Place ID for the event address. Will be NULL, for future development.</value>
                [JsonRequired]
              ...
              /// </summary>
              /// <value>Link to address location on Google Maps. Will be NULL, for future development.</value>
                [JsonRequired]
              ...
              /// </summary>
              /// <value>Latitude for the event address. Will be NULL, for future development.</value>
                [JsonRequired]
              ...
              /// </summary>
              /// <value>Longitude for the event address. Will be NULL, for future development.</value>
                [JsonRequired]
              ...
              /// </summary>
              /// <value>Playoff Type, as defined under &#x60;PlayoffType&#x60;: https://github.com/the-blue-alliance/the-blue-alliance/blob/main/src/backend/common/consts/playoff_type.py#L37, or null.</value>
                [JsonRequired]
              ...
              /// </summary>
              /// <value>Map of temporary \&quot;off-season demo\&quot; team numbers to pre-rookie and B teams. Both keys and values are team keys in the format &#39;frc####&#39;. Key is the old team key (&#39;frc&#39; + numeric only), value is the new team key (&#39;frc&#39; + numeric + may include a letter suffix).</value>
                [JsonRequired]
                  [JsonPropertyName("remap_teams")]
