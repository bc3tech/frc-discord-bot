...
public partial record MatchScoreBreakdown2015Alliance
{
    ...
    public MatchScoreBreakdown2015Alliance(int? adjustPoints = default, string? auto = default, int? autoPoints = default, int? containerCountLevel1 = default, int? containerCountLevel2 = default, int? containerCountLevel3 = default, int? containerCountLevel4 = default, int? containerCountLevel5 = default, int? containerCountLevel6 = default, int? containerPoints = default, bool? containerSet = default, string? foul = default, int? foulCount = default, int? foulPoints = default, int? litterCountContainer = default, int? litterCountLandfill = default, int? litterCountUnprocessed = default, int? litterPoints = default, bool? robotSet = default, int? teleopPoints = default, int? totalPoints = default, int? toteCountFar = default, int? toteCountNear = default, int? totePoints = default, bool? toteSet = default, bool? toteStack = default)
    {
