...
public partial record Match
{
    ...
    /// <summary>
    /// Gets or Sets CompLevel
    /// </summary>
    [JsonRequired]
    [JsonPropertyName("comp_level")]
    public CompLevel CompLevel { get; set; }
    /// <summary>
    ...
    /// <param name="compLevel">compLevel (required).</param>
    ...
    public Match(long? actualTime, MatchAlliances alliances, CompLevel compLevel, string eventKey, string key, int matchNumber, long? postResultTime, long? predictedTime, MatchScoreBreakdown scoreBreakdown, int setNumber, long? time, Collection<MatchVideosInner> videos, WinningAllianceEnum winningAlliance)
    {
