...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
  public partial record RegionalRankingEventPointsInner
  {
              // yup
              /// <summary>
              /// Initializes a new instance of the <see cref="RegionalRankingEventPointsInner" /> class.
              /// </summary>
              [JsonConstructor]
              protected RegionalRankingEventPointsInner() { 
            }
        ...
        public RegionalRankingEventPointsInner(int alliancePoints, int awardPoints, int elimPoints, string eventKey, int qualPoints, int total)
        {
