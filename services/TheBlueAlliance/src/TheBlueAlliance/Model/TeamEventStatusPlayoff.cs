...
/// </summary>
  ...
  public enum StatusEnum
  {
    ...
    public static string StatusEnumToJsonValue(StatusEnum value)
    {
        ...
        public TeamEventStatusPlayoff(WLTRecord? currentLevelRecord = default, LevelEnum? level = default, float? playoffAverage = default, WLTRecord? record = default, StatusEnum? status = default)
        {
