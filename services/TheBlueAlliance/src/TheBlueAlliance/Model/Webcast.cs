...
public partial record Webcast
{
    ...
    /// </summary>
    /// <value>The online status of the webcast, fetched from the streaming provider&#39;s API. May be null if not available.</value>
    ...
    /// <param name="status">The online status of the webcast, fetched from the streaming provider&#39;s API. May be null if not available.</param>
    /// <param name="streamTitle">The title of the stream from the streaming provider. May be null.</param>
    /// <param name="type">Type of webcast, typically descriptive of the streaming provider. (required).</param>
    /// <param name="viewerCount">The current viewer count from the streaming provider. May be null.</param>
    public Webcast(string channel, TypeEnum type, string? date = default, string? file = default, StatusEnum? status = default, string? streamTitle = default, int? viewerCount = default)
    {
    ...
    /// </summary>
    /// <value>The title of the stream from the streaming provider. May be null.</value>
    ...
    /// </summary>
    /// <value>The current viewer count from the streaming provider. May be null.</value>
