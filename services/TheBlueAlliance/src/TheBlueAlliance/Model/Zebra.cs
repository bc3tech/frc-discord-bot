...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
  public partial class Zebra
  {
        ...
        public Zebra(ZebraAlliances alliances, string key, Collection<float> times)
        {
              ...
              /// <value>A list of relative timestamps for each data point. Each timestamp will correspond to the X and Y value at the same index in a team xs and ys arrays. &#x60;times&#x60;, all teams &#x60;xs&#x60; and all teams &#x60;ys&#x60; are guarenteed to be the same length.</value>
                [JsonRequired]
                  ...
                  public Collection<float> Times { get; set; }
              ...
              public override string ToString()
              {
                ...
                sb.AppendLine("class Zebra {");
                    sb.Append("  Alliances: ").AppendLine($"{ Alliances }");
                    sb.Append("  Key: ").AppendLine($"{ Key }");
                    sb.Append("  Times: ").AppendLine($"{(Times is null ? "[null]" : string.Join(", ", Times))}");
                sb.AppendLine("}");
                return sb.ToString();
              }
