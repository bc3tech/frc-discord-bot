...
public partial record MatchScoreBreakdown2024Alliance
{
    ...
    public EndGameRobot2024? EndGameRobot1 { get; set; }
    ...
    public EndGameRobot2024? EndGameRobot2 { get; set; }
    ...
    public EndGameRobot2024? EndGameRobot3 { get; set; }
    // yup
    /// <summary>
    /// Initializes a new instance of the <see cref="MatchScoreBreakdown2024Alliance" /> class.
    /// </summary>
    [JsonConstructor]
    protected MatchScoreBreakdown2024Alliance()
    {
    }
    ...
    public MatchScoreBreakdown2024Alliance(int rp, int totalPoints, int? adjustPoints = default, int? autoAmpNoteCount = default, int? autoAmpNotePoints = default, int? autoLeavePoints = default, AutoLineRobot2024? autoLineRobot1 = default, AutoLineRobot2024? autoLineRobot2 = default, AutoLineRobot2024? autoLineRobot3 = default, int? autoPoints = default, int? autoSpeakerNoteCount = default, int? autoSpeakerNotePoints = default, int? autoTotalNotePoints = default, bool? coopNotePlayed = default, bool? coopertitionBonusAchieved = default, bool? coopertitionCriteriaMet = default, int? endGameHarmonyPoints = default, int? endGameNoteInTrapPoints = default, int? endGameOnStagePoints = default, int? endGameParkPoints = default, EndGameRobot2024? endGameRobot1 = default, EndGameRobot2024? endGameRobot2 = default, EndGameRobot2024? endGameRobot3 = default, int? endGameSpotLightBonusPoints = default, int? endGameTotalStagePoints = default, bool? ensembleBonusAchieved = default, int? ensembleBonusOnStageRobotsThreshold = default, int? ensembleBonusStagePointsThreshold = default, int? foulCount = default, int? foulPoints = default, bool? g206Penalty = default, bool? g408Penalty = default, bool? g424Penalty = default, bool? melodyBonusAchieved = default, int? melodyBonusThreshold = default, int? melodyBonusThresholdCoop = default, int? melodyBonusThresholdNonCoop = default, bool? micCenterStage = default, bool? micStageLeft = default, bool? micStageRight = default, int? techFoulCount = default, int? teleopAmpNoteCount = default, int? teleopAmpNotePoints = default, int? teleopPoints = default, int? teleopSpeakerNoteAmplifiedCount = default, int? teleopSpeakerNoteAmplifiedPoints = default, int? teleopSpeakerNoteCount = default, int? teleopSpeakerNotePoints = default, int? teleopTotalNotePoints = default, bool? trapCenterStage = default, bool? trapStageLeft = default, bool? trapStageRight = default)
    {
