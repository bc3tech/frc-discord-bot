...
public partial record MatchAlliance
{
    ...
    /// <param name="score">Score for this alliance. Will be -1 for an unplayed match. (required).</param>
    ...
    /// </summary>
    /// <value>Score for this alliance. Will be -1 for an unplayed match.</value>
    [JsonRequired]
