...
public partial record TeamEventStatusAlliance
{
    ...
    /// Initializes a new instance of the <see cref="TeamEventStatusAlliance" /> class.
    /// </summary>
    /// <param name="backup">Backup status, may be null.</param>
    ...
    public TeamEventStatusAlliance(int number, int pick, object? backup = default, string? name = default)
    {
        this.Backup = backup;
        this.Name = name;
        this.Number = number;
    ...
    /// </summary>
    /// <value>Backup status, may be null.</value>
