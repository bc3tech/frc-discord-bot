...
public partial record Team
{
    ...
    /// <param name="motto">Team&#39;s motto or tagline. (required).</param>
    ...
    /// <param name="website">Official website associated with the team. (required).</param>
    public Team(string address, string city, string country, string gmapsPlaceId, string gmapsUrl, string key, double? lat, double? lng, string locationName, string motto, string name, string nickname, string postalCode, int? rookieYear, string schoolName, string stateProv, int teamNumber, string website)
    {
    ...
    /// </summary>
    /// <value>Team&#39;s motto or tagline.</value>
    [JsonRequired]
