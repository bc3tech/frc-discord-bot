...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
  public partial record EventSimple
  {
        ...
        public EventSimple(string city, string country, District district, DateOnly endDate, string eventCode, int eventType, string key, string name, DateOnly startDate, string stateProv, int year)
        {
