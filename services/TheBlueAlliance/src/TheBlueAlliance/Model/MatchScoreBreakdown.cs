 ...
 */
  ...
  /// </summary>
    ...
    public sealed partial class MatchScoreBreakdown : AbstractOpenAPISchema
    {
      ...
      public override object? ActualInstance
      {
        ...
        set
        {
          ...
          _ => throw new ArgumentException("Invalid instance found. Must be the following types: [MatchScoreBreakdown2015, MatchScoreBreakdown2016, MatchScoreBreakdown2017, MatchScoreBreakdown2018, MatchScoreBreakdown2019, MatchScoreBreakdown2020, MatchScoreBreakdown2022, MatchScoreBreakdown2023, MatchScoreBreakdown2024]")
        };
      }
    }
    ...
    public override string ToString()
    {
      ...
      sb.AppendLine("class MatchScoreBreakdown {");
